...
import { MemoryView, QuizView, SudokuView, WordRushView, WordSearchView } from './views';
...
export const wordSearch = definePlugin({
  ...
  title: 'Word Search',
  instructions: 'Find every word hidden in the grid. Drag across a word, or click its first and last letters.',
  View: WordSearchView,
});
...
/** Every game with its web view. Pass to <SageGameProvider games={allGames}>. */
